const tokens = {
  ...
  "colors.danger-light": {
    "value": "#fff0f0",
    "variable": "var(--colors-danger-light)"
  },
  "colors.danger-border": {
    "value": "#fecaca",
    "variable": "var(--colors-danger-border)"
  },
  "fonts.serif": {
  ...
  "fonts.sans": {
    "value": "var(--font-geist-sans, \"Inter\"), -apple-system, BlinkMacSystemFont, \"Segoe UI\", sans-serif",
  ...
  "shadows.brand": {
    "value": "0 2px 8px rgba(59,59,255,0.3)",
    "variable": "var(--shadows-brand)"
  },
  "sizes.0": {
    "value": "0rem",
  ...
  "sizes.sidebar-expanded": {
    "value": "220px",
    "variable": "var(--sizes-sidebar-expanded)"
  },
  "sizes.breakpoint-sm": {
    "value": "640px",
